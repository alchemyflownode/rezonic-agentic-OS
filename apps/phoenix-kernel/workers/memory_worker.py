...
class PCHiveMemory:
    ...
    async def harvest_chatgpt_export(self, filepath: str) -> str:
        ...
        path = Path(filepath)
        if not path.exists():
            return f"Ã¢ÂÅ’ Error: Could not find export file at {filepath}"
        ...
        try:
            ...
            return f"Ã¢Å“â€¦ Successfully harvested {count} conversation threads into the Symbiote Cortex."
        except Exception as e:
            return f"Ã¢ÂÅ’ Harvest failed: {str(e)}"
