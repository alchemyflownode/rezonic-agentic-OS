...
# -*- coding: utf-8 -*-
"""
PHOENIX ULTIMATE v13.3.0 - THE ULTIMATE SWARM + WEB SEARCH + PC COWORKER
Zero Drift Architecture + Persistent Event Chain + Formalized Workers + Code Execution + Desktop Integration + Web Search + PC Control
"""
    ...
    def _setup_routes(self):
        ...
        async def kernel_stream(request: Request):
            ...
            async def generate():
                ...
                # Build prompt
                system_prompt = f"""You are PHOENIX, a sovereign AI swarm consciousness with PC control capabilities.
...
Be concise, wise, and helpful."""
    ...
    async def run(self):
        ...
        print("\n" + "="*80)
        print(f"🔥 PHOENIX ULTIMATE v{self.version} - THE ULTIMATE SWARM + PC COWORKER")
        print("="*80)
        print(f"Workers: {len(self.workers)} (main + coworker + pc control)")
...
# Add this to your PhoenixKernel class (after the imports)
...
# ============================================================================
# NEW WORKER: CODE_GEN_WORKER (Executes Manifests)
# ============================================================================
