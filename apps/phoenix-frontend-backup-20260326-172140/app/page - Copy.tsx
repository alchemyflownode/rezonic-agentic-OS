...
import { 
  ...
  TrendingUp, TrendingDown, Wallet, BarChart3, Clock, AlertTriangle,
  Power, RefreshCw, DollarSign, Globe, Wifi, WifiOff, MemoryStick,
  HardDrive, Database, Shield as ShieldIcon
} from 'lucide-react';
  ...
  return (
    <div className="h-screen bg-gradient-to-br from-[#0a0a0c] via-[#050505] to-[#0a0a0c] text-[#c0caf5] overflow-hidden">
      ...
      <header className="relative z-10 flex items-center justify-between px-6 py-3 border-b border-[#7dcfff]/10 bg-black/40 backdrop-blur-xl">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="text-right">
            ...
            <div className="text-xs font-bold text-white">{workers.length}</div>
          </div>
        </div>
      </header>
      ...
      <div className="relative z-10 h-[calc(100vh-60px)] overflow-y-auto custom-scrollbar">
              ...
              <div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between items-center p-3 bg-white/5 rounded-xl">
                    ...
                    <span className="text-xs font-mono text-white">{workers.length} / 70</span>
                  </div>
                  <div className="flex justify-between items-center p-3 bg-white/5 rounded-xl">
                    <span className="text-xs">SCE Integrity</span>
                    <span className="text-xs font-mono text-[#9ece6a]">98%</span>
                  </div>
                  <div className="flex justify-between items-center p-3 bg-gradient-to-r from-[#7dcfff]/10 to-[#9B72CB]/10 rounded-xl">
                    ...
                    <span className={`text-xs font-mono ${comfyui.connected ? 'text-[#9ece6a]' : 'text-[#f7768e]'}`}>
                      {comfyui.connected ? 'ACTIVE' : 'OFFLINE'}
                    </span>
                  </div>
                  {killSwitch.active && (
                          ...
                          {msg.role === 'assistant' || msg.role === 'system' ? (
                            ...
                            <div className="p-4 rounded-2xl bg-white/5 border border-white/10 rounded-bl-sm">
                              ...
                              <div className="flex items-center gap-2 mt-2">
                                <span className="text-[8px] text-[#565f89]">{new Date(msg.timestamp).toLocaleTimeString()}</span>
                              </div>
                            </div>
                          )}
                        </div>
            ...
            <aside className="w-80 bg-black/30 backdrop-blur-xl border border-[#7dcfff]/10 rounded-2xl p-5 flex flex-col gap-4 sticky top-4 h-[calc(100vh-100px)] shrink-0">
              ...
              <div className="flex-1 overflow-y-auto space-y-2 custom-scrollbar">
                <CommandCard
                  ...
                  example="/generate cyberpunk cat"
                />
                <CommandCard
                  name="/video"
                  description="Generate video (AnimateDiff)"
                  example="/video cat running"
                />
                <CommandCard
                  name="/code"
                  description="Generate Python code"
                  example="/code moving average strategy"
                />
                <CommandCard
                  name="/health"
                ...
                <CommandCard
                  ...
                  example="/trade buy BTC/PHP 0.01"
                />
              </div>
        ...
        {/* (Keep your existing sections here - they remain the same) */}
