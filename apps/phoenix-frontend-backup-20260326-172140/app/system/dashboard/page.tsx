// app/page.tsx - Your beautiful original design with Zustand integration
'use client';
...
export default function SovereignDashboard() {
  ...
  // Convert store messages to your format
  ...
  const workerCount = storeWorkers.length;
  ...
  const checkComfyUI = async () => {
    try {
      ...
      if (res.ok) {
        // Status is already in store from usePhoenix
      }
    } catch {
      // Handle error
    }
  ...
  return (
    <div className="h-screen bg-gradient-to-br from-[#0a0a0c] via-[#050505] to-[#0a0a0c] text-[#c0caf5] overflow-hidden">
      ...
      <header className="relative z-10 flex items-center justify-between px-6 py-3 border-b border-[#7dcfff]/10 bg-black/40 backdrop-blur-xl">
        <div className="flex items-center gap-8 text-[10px] font-mono">
          <div className="flex items-center gap-2">
            <div className={`w-2 h-2 rounded-full ${kernelStatus === true ? 'bg-[#9ece6a] animate-pulse' : 'bg-[#f7768e]'}`} />
            <span className={kernelStatus === true ? 'text-[#9ece6a]' : 'text-[#f7768e]'}>
              KERNEL: {kernelStatus === true ? 'ACTIVE' : 'OFFLINE'}
            </span>
          </div>
          <div className="flex items-center gap-2">
      ...
      <div className="relative z-10 h-[calc(100vh-60px)] overflow-y-auto custom-scrollbar">
                ...
                <div className="p-4 border-t border-[#7dcfff]/10 bg-black/20">
                  <div className="flex gap-2">
                    <textarea
                      ...
                      placeholder={kernelStatus === true ? "Execute command, ask a question, or /generate an image..." : "Awaiting kernel connection..."}
                    ...
                    <button
                      ...
                      disabled={!prompt.trim() || isStreaming || kernelStatus !== true}
        ...
        {/* ===== SECTIONS FOR NAVIGATION (Keep your existing sections) ===== */}
        {/* PROTOCOL SECTION */}
        ...
        <section id="audit" className="scroll-mt-20 py-20 px-8 border-t border-[#7dcfff]/10 bg-gradient-to-b from-transparent to-black/20">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="bg-[#0a0a0c] border border-white/[0.05] rounded-xl p-6 font-mono text-xs">
              <div className="text-[#9ece6a] mb-4">DRIFT CHAIN — ACTIVE</div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-[#0a0a0c] border border-white/[0.05] rounded-xl p-6 hover:border-[#9ece6a]/30 transition-all">
                ...
                <button className="text-xs text-[#9ece6a] flex items-center gap-1">Download PDF →</button>
              </div>
              <div className="bg-[#0a0a0c] border border-white/[0.05] rounded-xl p-6 hover:border-[#9ece6a]/30 transition-all">
                ...
                <button className="text-xs text-[#9ece6a] flex items-center gap-1">Read Guide →</button>
              </div>
              <div className="bg-[#0a0a0c] border border-white/[0.05] rounded-xl p-6 hover:border-[#9ece6a]/30 transition-all">
                ...
                <button className="text-xs text-[#9ece6a] flex items-center gap-1">View API →</button>
              </div>
            </div>
          </div>
        </section>
