// app/page.tsx - CLEAN LANDING PAGE (No Sidebar)
'use client';
      ...
      <footer className="py-8 px-6 border-t border-[#7dcfff]/10">
        <div className="container mx-auto text-center text-[10px] text-[#565f89]">
          ...
          <div className="flex justify-center gap-6 mt-4">
            ...
            <Link href="/apex-trader" className="hover:text-[#7dcfff] transition">Trading</Link>
            <Link href="/system/workers" className="hover:text-[#7dcfff] transition">Workers</Link>
          </div>
        </div>
      </footer>
    </div>
