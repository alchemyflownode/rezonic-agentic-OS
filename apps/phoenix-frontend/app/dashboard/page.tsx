...
export default function SovereignDashboard() {
  ...
  useEffect(() => {
    connect(); // Uses default admin key
  }, []);
  ...
  return (
    <div className="h-screen bg-gradient-to-br from-[#0a0a0c] via-[#050505] to-[#0a0a0c] text-[#c0caf5] overflow-hidden">
      ...
      <header className="relative z-10 flex items-center justify-between px-6 py-3 border-b border-[#7dcfff]/10 bg-black/40 backdrop-blur-xl">
        <div className="flex items-center gap-8 text-[10px] font-mono">
          <div className="flex items-center gap-2">
            <div className={`w-2 h-2 rounded-full ${kernelStatus ? 'bg-[#9ece6a] animate-pulse' : 'bg-[#f7768e]'}`} />
            <span className={kernelStatus ? 'text-[#9ece6a]' : 'text-[#f7768e]'}>
              KERNEL: {kernelStatus ? 'ACTIVE' : 'OFFLINE'}
            </span>
          </div>
          <div className="flex items-center gap-2">
      ...
      <div className="relative z-10 h-[calc(100vh-60px)] overflow-y-auto custom-scrollbar">
                ...
                <div className="p-4 border-t border-[#7dcfff]/10 bg-black/20">
                  <div className="flex gap-2">
                    <textarea
                      ...
                      placeholder={kernelStatus ? "Execute command, ask a question, or /generate an image..." : "Awaiting kernel connection..."}
                    ...
                    <button
                      onClick={handleSend}
                      disabled={!prompt.trim() || isStreaming || !kernelStatus}
        ...
        {/* Keep your existing sections - they remain the same */}
        {/* PROTOCOL SECTION, WORKERS SECTION, COMFYUI SECTION, AUDIT SECTION, DOCS SECTION */}
        {/* (copy these from your original file - they don't need changes) */}
